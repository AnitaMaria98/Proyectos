									...
									<tbody>
										...
										<tr>
											...
											%>
												...
												<td rowspan="2" width='60' style="text-align: center;" class="Simple"><%=controladorBD.CartaSimple(cod_jugador, nombre).get(j).getRat() %></td>	
												...
												<td rowspan="2" width='60' style="text-align: center;" class="<%=colorPac %>"><%=controladorBD.CartaSimple(cod_jugador, nombre).get(j).getPac()%></td>	
												
												<td rowspan="2" width='60' style="text-align: center;" class="<%=colorSho%>" ><%=controladorBD.CartaSimple(cod_jugador, nombre).get(j).getSho() %></td>	
												
												<td rowspan="2" width='60' style="text-align: center;" class="<%=colorPas%>"><%=controladorBD.CartaSimple(cod_jugador, nombre).get(j).getPas() %></td>	
													
												<td rowspan="2" width='60' style="text-align: center;" class="<%=colorDri%>"><%=controladorBD.CartaSimple(cod_jugador, nombre).get(j).getDri() %></td>	
													
												<td rowspan="2" width='60' style="text-align: center;" class="<%=colorDef %>"><%=controladorBD.CartaSimple(cod_jugador, nombre).get(j).getDef()%></td>	
												
												<td rowspan="2" width='60' style="text-align: center;" class="<%=colorPhi%>"><%=controladorBD.CartaSimple(cod_jugador, nombre).get(j).getPhy() %></td>
